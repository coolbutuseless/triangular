...
* [polyclip](https://cran.r-project.org/package=polyclip) which is licensed [BSL](https://www.boost.org/LICENSE_1_0.txt)
...
* `{polyclip}` separates the input polygons into simpler non-intersecting polygons,
  but does not necessarily decompose the inputs into triangles.
...
#   geom_polygon(aes(x, y, subgroup = subgroup), fill = 'grey20', colour = 'red')  + 
#   # geom_line(aes(x, y)) + 
#   theme_bw() + 
#   coord_equal()
# 
